...
export default function Home() {
  ...
  return (
    <>
      ...
      {screen === 3 && (
        <div key={fadeKey} className="quiz-screen" style={{ minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "center", padding: "140px 48px 80px", maxWidth: 600, marginLeft: "auto", marginRight: "auto" }}>
